...
Class  Newsletter_model extends CI_Model
{
	...
	function getdata($page=0,$csv=FALSE)
	{
		...
		$query = $this->db->get('subscribeduser'); 
	 ...
	 function set_search()
    {
       ...
       {
           $this->session->set_userdata('newsletter_search',$_POST);
       } 
    
       if($this->session->userdata('newsletter_search'))
       {
           $data = $this->session->userdata('newsletter_search');
