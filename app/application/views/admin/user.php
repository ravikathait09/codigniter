                                    ...
                                    <table id="table-object" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tr>
												<th class="per5">
                                                    <div class="checkbox-custom">
                                                        <input type="checkbox" value="option1" id="masterCheck" name="id[]"onclick="checkall(this)" class="check-all">
										...
										<tr>
												...
												<td>
													...
													<a href="<?=base_url('admin/user/adduser/1/'.$value['id'])?>" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil"></i></a>
													
													<a href="#" onclick="deletesingle('<?=base_url('admin/delete/deleteuser/'.$value['id'])?>')"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
												</td>
